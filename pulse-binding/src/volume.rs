...
impl ChannelVolumes {
    ...
    pub fn equal_to(&self, to: &Self) -> bool {
        unsafe { capi::pa_cvolume_equal(mem::transmute(self), mem::transmute(to)) != 0 }
    }
    ...
    pub fn avg(&self) -> Volume {
        Volume(unsafe { capi::pa_cvolume_avg(mem::transmute(self)) })
    }
        ...
        -> Volume
    {
        ...
        Volume(unsafe { capi::pa_cvolume_avg_mask(mem::transmute(self), mem::transmute(cm),
            mask_actual) })
    }

    /// Return the maximum volume of all channels.
    pub fn max(&self) -> Volume {
        Volume(unsafe { capi::pa_cvolume_max(mem::transmute(self)) })
    }
    ...
    {
        let mask_actual = mask.unwrap_or(channelmap::POSITION_MASK_ALL);
        Volume(unsafe { capi::pa_cvolume_max_mask(mem::transmute(self), mem::transmute(cm),
            mask_actual) })
    }

    /// Return the minimum volume of all channels.
    pub fn min(&self) -> Volume {
        Volume(unsafe { capi::pa_cvolume_min(mem::transmute(self)) })
    }
    ...
    {
        let mask_actual = mask.unwrap_or(channelmap::POSITION_MASK_ALL);
        Volume(unsafe { capi::pa_cvolume_min_mask(mem::transmute(self), mem::transmute(cm),
            mask_actual) })
    }

    /// Returns `true` when the `ChannelVolumes` structure is valid.
    pub fn is_valid(&self) -> bool {
        unsafe { capi::pa_cvolume_valid(mem::transmute(self)) != 0 }
    }

    /// Returns `true` if the volume of all channels are equal to the specified value.
    pub fn channels_equal_to(&self, v: Volume) -> bool {
        unsafe { capi::pa_cvolume_channels_equal_to(mem::transmute(self), v.0) != 0 }
    }
    ...
    pub fn sw_multiply(&mut self, with: Option<&Self>) -> &mut Self {
        unsafe { capi::pa_sw_cvolume_multiply(mem::transmute(&self), mem::transmute(&self),
            mem::transmute(with.unwrap_or(&*self))) };
        self
    }
    ...
    pub fn sw_multiply_scalar(&mut self, with: Volume) -> &mut Self {
        unsafe { capi::pa_sw_cvolume_multiply_scalar(mem::transmute(&self), mem::transmute(&self),
            with.0) };
        self
    }
    ...
    pub fn sw_divide(&mut self, with: Option<&Self>) -> &mut Self {
        match with {
            Some(with) => unsafe {
                capi::pa_sw_cvolume_divide(mem::transmute(&self), mem::transmute(&self),
                    mem::transmute(with))
            },
            None => unsafe {
                capi::pa_sw_cvolume_divide(mem::transmute(&self), mem::transmute(&self),
    ...
    pub fn sw_divide_scalar(&mut self, with: Volume) -> &mut Self {
        unsafe { capi::pa_sw_cvolume_divide_scalar(mem::transmute(&self), mem::transmute(&self),
            with.0) };
        self
    }
    ...
    pub fn remap(&mut self, from: &channelmap::Map, to: &channelmap::Map) -> &mut Self {
        unsafe { capi::pa_cvolume_remap(mem::transmute(&self), mem::transmute(from),
            mem::transmute(to)) };
        self
    }
    ...
    pub fn is_compatible_with_ss(&self, ss: &sample::Spec) -> bool {
        unsafe { capi::pa_cvolume_compatible(mem::transmute(self), mem::transmute(ss)) != 0 }
    }
    ...
    pub fn is_compatible_with_cm(&self, cm: &channelmap::Map) -> bool {
        unsafe { capi::pa_cvolume_compatible_with_channel_map(mem::transmute(self),
            mem::transmute(cm)) != 0 }
    }
    ...
    pub fn get_balance(&self, map: &channelmap::Map) -> f32 {
        unsafe { capi::pa_cvolume_get_balance(mem::transmute(self), mem::transmute(map)) }
    }
    ...
    pub fn set_balance(&mut self, map: &channelmap::Map, new_balance: f32) -> Option<&mut Self> {
        let ptr = unsafe { capi::pa_cvolume_set_balance(mem::transmute(&self),
            mem::transmute(map), new_balance) };
        if ptr.is_null() {
            return None;
        }
        Some(self)
    ...
    pub fn get_fade(&self, map: &channelmap::Map) -> f32 {
        unsafe { capi::pa_cvolume_get_fade(mem::transmute(self), mem::transmute(map)) }
    }
    ...
    pub fn set_fade(&mut self, map: &channelmap::Map, new_fade: f32) -> Option<&mut Self>{
        let ptr = unsafe { capi::pa_cvolume_set_fade(mem::transmute(&self),
            mem::transmute(map), new_fade) };
        if ptr.is_null() {
            return None;
        }
        Some(self)
    ...
    pub fn get_lfe_balance(&self, map: &channelmap::Map) -> f32 {
        unsafe { capi::pa_cvolume_get_lfe_balance(mem::transmute(self), mem::transmute(map)) }
    }
    ...
    pub fn set_lfe_balance(&mut self, map: &channelmap::Map, new_balance: f32)
        -> Option<&mut Self>
    {
        let ptr = unsafe { capi::pa_cvolume_set_lfe_balance(mem::transmute(&self),
            mem::transmute(map), new_balance) };
        if ptr.is_null() {
            return None;
        }
    ...
    pub fn scale(&mut self, max: Volume) -> Option<&mut Self> {
        let ptr = unsafe { capi::pa_cvolume_scale(mem::transmute(&self), max.0) };
        if ptr.is_null() {
            return None;
        }
        Some(self)
    ...
    {
        let mask_actual = mask.unwrap_or(channelmap::POSITION_MASK_ALL);
        let ptr = unsafe { capi::pa_cvolume_scale_mask(mem::transmute(&self), max.0,
            mem::transmute(cm), mask_actual) };
        if ptr.is_null() {
            return None;
        }
        Some(self)
        ...
        -> Option<&mut Self>
    {
        ...
        let ptr = unsafe { capi::pa_cvolume_set_position(mem::transmute(&self),
            mem::transmute(map), t.into(), v.0) };
        if ptr.is_null() {
            return None;
        }
        Some(self)
    ...
    pub fn get_position(&self, map: &channelmap::Map, t: channelmap::Position) -> Volume {
        Volume(unsafe { capi::pa_cvolume_get_position(mem::transmute(self),
            mem::transmute(map), t.into()) })
    }
    ...
    pub fn merge(&mut self, with: &Self) -> Option<&mut Self> {
        let ptr = unsafe { capi::pa_cvolume_merge(mem::transmute(&self), mem::transmute(&self),
            mem::transmute(with)) };
        if ptr.is_null() {
            return None;
        }
    ...
    pub fn inc_clamp(&mut self, inc: Volume, limit: Volume) -> Option<&mut Self> {
        let ptr = unsafe { capi::pa_cvolume_inc_clamp(mem::transmute(&self), inc.0, limit.0) };
        if ptr.is_null() {
            return None;
        }
        Some(self)
    ...
    pub fn increase(&mut self, inc: Volume) -> Option<&mut Self> {
        let ptr = unsafe { capi::pa_cvolume_inc(mem::transmute(&self), inc.0) };
        if ptr.is_null() {
            return None;
        }
        Some(self)
    ...
    pub fn decrease(&mut self, dec: Volume) -> Option<&mut Self> {
        let ptr = unsafe { capi::pa_cvolume_dec(mem::transmute(&self), dec.0) };
        if ptr.is_null() {
            return None;
        }
        Some(self)
    ...
    pub fn print(&self) -> String {
        ...
        let mut tmp = Vec::with_capacity(PRINT_MAX);
        unsafe {
            capi::pa_cvolume_snprint(tmp.as_mut_ptr(), PRINT_MAX, mem::transmute(self));
            CStr::from_ptr(tmp.as_mut_ptr()).to_string_lossy().into_owned()
        }
    }
    ...
    pub fn print_db(&self) -> String {
        ...
        let mut tmp = Vec::with_capacity(PRINT_DB_MAX);
        unsafe {
            capi::pa_sw_cvolume_snprint_dB(tmp.as_mut_ptr(), PRINT_DB_MAX, mem::transmute(self));
            CStr::from_ptr(tmp.as_mut_ptr()).to_string_lossy().into_owned()
        }
    }
    ...
    pub fn print_verbose(&self, map: Option<&channelmap::Map>, print_db: bool) -> String {
        ...
        unsafe {
            capi::pa_cvolume_snprint_verbose(tmp.as_mut_ptr(), PRINT_VERBOSE_MAX,
                mem::transmute(self), p_map, print_db as i32);
            CStr::from_ptr(tmp.as_mut_ptr()).to_string_lossy().into_owned()
        }
    }
}
