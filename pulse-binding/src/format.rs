...
impl Info {
    ...
    pub fn new() -> Option<Self> {
        ...
        Some(Self::from_raw(unsafe { mem::transmute(ptr) }))
    }
        ...
        -> Option<Self>
    {
        ...
        let ptr = unsafe { capi::pa_format_info_from_sample_spec(mem::transmute(ss), p_map) };
        if ptr.is_null() {
            return None;
        }
        Some(Self::from_raw(unsafe { mem::transmute(ptr) }))
    ...
    pub fn is_valid(&self) -> bool {
        unsafe { capi::pa_format_info_valid(mem::transmute(&self.ptr)) != 0 }
    }

    /// Returns whether the `Info` structure represents a PCM (i.e. uncompressed data) format.
    pub fn is_pcm(&self) -> bool {
        unsafe { capi::pa_format_info_is_pcm(mem::transmute(&self.ptr)) != 0 }
    }
    ...
    pub fn is_compatible_with(&self, with: &Self) -> bool {
        unsafe { capi::pa_format_info_is_compatible(mem::transmute(&self.ptr),
            mem::transmute(&with.ptr)) != 0 }
    }
    ...
    pub fn print(&self) -> String {
        ...
        unsafe {
            capi::pa_format_info_snprint(tmp.as_mut_ptr(), PRINT_MAX, mem::transmute(&self.ptr));
    ...
    pub fn to_sample_spec(&self, ss: &mut sample::Spec, map: &mut channelmap::Map)
        -> Result<(), PAErr>
    {
        match unsafe { capi::pa_format_info_to_sample_spec(mem::transmute(&self.ptr),
            mem::transmute(ss), mem::transmute(map)) }
        {
            0 => Ok(()),
            e => Err(PAErr(e)),
        }
    ...
    pub fn get_prop_type(&self, key: &str) -> PropType {
        ...
        unsafe { capi::pa_format_info_get_prop_type(mem::transmute(&self.ptr), c_key.as_ptr()) }
    }
    ...
    pub fn get_prop_int(&self, key: &str) -> Result<i32, PAErr> {
        ...
        let mut i: i32 = 0;
        let c_key = CString::new(key.clone()).unwrap();
        match unsafe { capi::pa_format_info_get_prop_int(mem::transmute(&self.ptr),
            c_key.as_ptr(), &mut i) }
        {
            0 => Ok(i),
            e => Err(PAErr(e)),
    ...
    pub fn get_prop_int_range(&self, key: &str) -> Result<(i32, i32), PAErr> {
        ...
        let mut max: i32 = 0;
        let c_key = CString::new(key.clone()).unwrap();
        match unsafe { capi::pa_format_info_get_prop_int_range(mem::transmute(&self.ptr),
    ...
    pub fn get_prop_int_array(&self, key: &str) -> Option<Vec<i32>> {
        ...
        let result = unsafe { capi::pa_format_info_get_prop_int_array(
            mem::transmute(&self.ptr), c_key.as_ptr(), &mut p_ints, &mut count) };
        if result != 0 {
            return None;
        }
    ...
    pub fn get_prop_string(&self, key: &str) -> Option<String> {
        ...
        let result = unsafe { capi::pa_format_info_get_prop_string(mem::transmute(&self.ptr),
    ...
    pub fn get_prop_string_array(&self, key: &str) -> Option<Vec<String>> {
        ...
        let result = unsafe { capi::pa_format_info_get_prop_string_array(
            mem::transmute(&self.ptr), c_key.as_ptr(), &mut pp_str, &mut count) };
    ...
    pub fn set_prop_int(&mut self, key: &str, value: i32) {
        ...
        // as_ptr() giving dangling pointers!
        let c_key = CString::new(key.clone()).unwrap();
        unsafe { capi::pa_format_info_set_prop_int(mem::transmute(&self.ptr), c_key.as_ptr(),
            value); }
    }
    ...
    pub fn set_prop_int_array(&mut self, key: &str, values: &[i32]) {
        ...
        // as_ptr() giving dangling pointers!
        let c_key = CString::new(key.clone()).unwrap();
        unsafe { capi::pa_format_info_set_prop_int_array(mem::transmute(&self.ptr),
    ...
    pub fn set_prop_int_range(&mut self, key: &str, min: i32, max: i32) {
        ...
        // as_ptr() giving dangling pointers!
        let c_key = CString::new(key.clone()).unwrap();
        unsafe { capi::pa_format_info_set_prop_int_range(mem::transmute(&self.ptr),
    ...
    pub fn set_prop_string(&mut self, key: &str, value: &str) {
        ...
        unsafe { capi::pa_format_info_set_prop_string(mem::transmute(&self.ptr),
    ...
    pub fn set_prop_string_array(&mut self, key: &str, values: &[&str]) {
        ...
        unsafe {
            capi::pa_format_info_set_prop_string_array(mem::transmute(&self.ptr),
    ...
    pub fn set_sample_format(&mut self, sf: sample::Format) {
        unsafe { capi::pa_format_info_set_sample_format(mem::transmute(&self.ptr),
            sf.into()); }
    }
    ...
    pub fn set_rate(&mut self, rate: i32) {
        unsafe { capi::pa_format_info_set_rate(mem::transmute(&self.ptr), rate) }
    }
    ...
    pub fn set_channels(&mut self, channels: u32) {
        ...
        unsafe { capi::pa_format_info_set_channels(mem::transmute(&self.ptr), channels as i32) }
    }
    ...
    pub fn set_channel_map(&mut self, map: &channelmap::Map) {
        unsafe { capi::pa_format_info_set_channel_map(mem::transmute(&self.ptr),
            mem::transmute(map)) }
    }
}
...
impl Drop for Info {
    fn drop(&mut self) {
        if !self.weak {
            unsafe { capi::pa_format_info_free(mem::transmute(&self.ptr)) };
        }
    }
}
...
impl Clone for Info {
    ...
    fn clone(&self) -> Self {
        let ptr = unsafe { capi::pa_format_info_copy(mem::transmute(&self.ptr)) };
        assert_eq!(false, ptr.is_null());
        Self::from_raw(unsafe { mem::transmute(ptr) })
    }
}
